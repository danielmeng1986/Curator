...
| Role-sensitive Operation-history diagnostics API | [Operation Logging](Specifications/Operation-Logging.md) | Reader/writer/admin disclosure policy at a stable API read boundary. | Not Implemented | [BT-030](Tasks/BT-030-operation-history-api-disclosure.md) |
