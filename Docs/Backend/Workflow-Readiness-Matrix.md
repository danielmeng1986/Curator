...
| Workspace Review field contract and promotion | [Workspace Workflow](Specifications/Workspace-Workflow.md) | Dataset-specific allowed Review changes and permanent promotion mapping. | Not Implemented | [BT-031](Tasks/BT-031-workspace-review-and-promotion-contract.md); implementation follows [MT-007](../Project/Tasks/MT-007-add-album-remark-schema-compatibility.md) and [MT-008](../Project/Tasks/MT-008-close-and-archive-historical-workspace-albums.md). |
...
| Album-exclusive Work Dispatch | [Work Dispatch Workflow](Specifications/Work-Dispatch-Workflow.md) | Admin filters arbitrary Albums, atomically creates one active Group/reservation per Album, runs comparable model Work Items, then safely releases with history. | Not Implemented | BT-054 through BT-057 and UI-011E/F; dispatch must precede the remaining AI Workspace execution/review acceptance path. |
